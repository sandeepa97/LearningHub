...
<html>
<h1>Level 1 _ Lesson 1 _ Quiz</h2>		
...
<body>
	...
	<div id="page-wrap">
		...
		<?php echo form_open('Admin/grade'); ?>
            ...
            <ol>
                ...
                <li>
                    ...
                    <h3>Who is the father of Modern Computer?</h3>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-A" value="A" />
                        <label for="question-5-answers-A">A) Steve Jobs</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-B" value="B" />
                        <label for="question-5-answers-B">B) Charles Babbage</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-C" value="C" />
                        <label for="question-5-answers-C">C) Hovard Aitken</label>
                    </div>
                    
                    <div>
                        <input type="radio" name="question-5-answers" id="question-5-answers-D" value="D" />
                        <label for="question-5-answers-D">D) Mark Zuckerbergh</label>
                    </div>
